	...
	*/								
	...
	foreach (var e in files)
	{
		...
		{	
			...
			{
				if (sorted.Count < pocetAtomuAMK * 2)
            ...
            var nejblizsiAtomCukr = sorted.ElementAt(0).First();
            ...
            */
            ...
            if (minDistance < 3.43 && minDistance != 0.0) //problém s řazením - atomy cukru se dostaly mezi atomy AMK
            {
